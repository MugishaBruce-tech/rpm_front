            ...
            {mfaStep ? (
              ...
              <>
                ...
                <div className="form-divider">
                  <span>{intl.formatMessage({ id: 'login.or_email' })}</span>
                </div>
                ...
                <div className="social-login">
                  <button type="button" className="social-btn" onClick={handleGoogleLogin}>
                    <svg className="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                      ...
                      <path fill="#FF3D00" d="m6.306 14.691 6.571 4.819C14.655 15.108 18.961 12 24 12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4c-7.539 0-14.113 4.141-17.694 10.691z" />
